...
Public Class rptPaySumary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PS_Management.rptPaySumary.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Years() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptPaySumary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPaySumary = New rptPaySumary()
        rpt.Site = Me.Site
        Return rpt
    End Function
