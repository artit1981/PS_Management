...
Public Class rptReceiptMain
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PS_Management.rptReceiptMain.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IsPrintCoppy() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptReceiptMain
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReceiptMain = New rptReceiptMain()
        rpt.Site = Me.Site
        Return rpt
    End Function
